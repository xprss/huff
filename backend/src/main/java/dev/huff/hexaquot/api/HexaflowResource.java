...
public class HexaflowResource {
    ...
    @POST @Path("/today/hints") public Response hint(@CookieParam("huff_session")String s,HexaflowDtos.HintRequest r){var u=users.resolve(s);return respond(u,u.user()==null?null:service.hint(u.user(),r));}
