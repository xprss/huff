...
class ApiSecurityFilterTest {
    ...
    private static Stream<Arguments> privateEndpoints() {
        return Stream.of(
            ...
            Arguments.of(Method.GET, "/api/hexastar/today"),
            Arguments.of(Method.POST, "/api/hexastar/today/guesses"),
            Arguments.of(Method.GET, "/api/hexastar/stats"),
            Arguments.of(Method.GET, "/api/hexaeco/today"),
            Arguments.of(Method.POST, "/api/hexaeco/today/submissions"),
            Arguments.of(Method.GET, "/api/hexaeco/stats"),
            Arguments.of(Method.GET, "/api/hexaeco/leaderboards"),
