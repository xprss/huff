...
export type AppRoute = "games" | "game" | "hexahack" | "hexasky" | "hexasquare" | "profile" | "admin" | "leaderboard" | "player";
...
function routeFromHash(hash: string): AppRoute {
  ...
  if (hash === "#/hexasquare") return "hexasquare";
  return "games";
}
...
function hashFromRoute(route: AppRoute) {
  ...
  if (route === "hexasquare") return "#/hexasquare";
  return "#/";
}
