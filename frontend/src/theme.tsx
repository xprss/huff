...
export const appThemes = [darkAppTheme, lightAppTheme, crazyPinkAppTheme, matrixAppTheme, pannaAppTheme, chromaticAppTheme] as const satisfies readonly AppTheme[];
