...
export const appThemes = [darkAppTheme, lightAppTheme, crazyPinkAppTheme, matrixAppTheme, pannaAppTheme, chromaticAppTheme, noirAppTheme, childhoodAppTheme] as const satisfies readonly AppTheme[];
