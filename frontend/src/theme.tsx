...
export const darkAppTheme: AppTheme = {
  ...
  colors: {
    ...
    surface: "#202722",
    surfaceSoft: "#252e27",
    surfaceStrong: "#354134",
    surfaceRaised: "#2b352d",
    surfaceGlass: "rgba(21, 25, 43, 0.78)",
    surfaceBorder: "#3b473c",
    tile: "#252e27",
    tileBorder: "#53634e",
    tileFilled: "#90a0c4",
    text: "#f0f3e9",
    ...
    focusRing: "rgba(197, 177, 241, 0.4)",
    modal: "#222a23",
    modalBorder: "#45513f",
    ...
    distributionBar: "#abd088",
    metricBackground: "#283126",
    metricBorder: "#45513f",
...
export const lightAppTheme: AppTheme = {
  ...
  colors: {
    ...
    surface: "#ffffff",
    surfaceSoft: "#eef0e8",
    surfaceStrong: "#e3e8d9",
    surfaceRaised: "#ffffff",
    surfaceGlass: "rgba(255, 255, 255, 0.82)",
    surfaceBorder: "#dfe3d7",
    tile: "#ffffff",
    tileBorder: "#bdc6b4",
    tileFilled: "#5f6f92",
    text: "#252b24",
    ...
    focusRing: "rgba(108, 81, 172, 0.35)",
    modal: "#ffffff",
    ...
    distributionBar: "#46734b",
    metricBackground: "#f2f4ec",
    metricBorder: "#dfe3d7",
...
export function getStoredThemeId(): string {
  ...
  return localStorage.getItem("darkMode") === "true" ? darkAppTheme.id : lightAppTheme.id;
}
